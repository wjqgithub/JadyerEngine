package com.jadyer.engine.common.util.tmp.money;
...
public class SimpleMoneyUtil {
	...
	public static String toChinese(BigDecimal money) {
		...
		return toChinese(money.toString());
	}
	...
	public static String toChinese(String moneyStr) {
		moneyStr = moneyStr.replaceAll(",", "");// 去掉","
		...
		if (moneyStr.indexOf(".") > 0) {
			...
			decimalStr = moneyStr.substring(moneyStr.indexOf(".") + 1);
		} else if (moneyStr.indexOf(".") == 0) {
			integerStr = "";
